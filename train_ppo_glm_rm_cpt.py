...
triton_client = httpclient.InferenceServerClient(url="10.212.207.33:12346", connection_timeout=300, network_timeout=300)
...
for cur_big_epoch in range(10):
    for epoch, batch in tqdm(enumerate(ppo_trainer.dataloader)):
        ...
        if (epoch+1) % 50 == 0 and str(ppo_trainer.accelerator.device) == "cuda:0":
            reward_path = "/search/ai/jamsluo/GLM_RLHF/ppo_glm/RLHF_sft06_rm_large_new2"
