...
class PPOIdxDataset(Dataset):
    def __init__(self, tokenizer):
        ...
        self.f = open("/search/ai/kaitongyang/ppo_glm_debug/data/bad_case_prompt/fu_1_zheng_2.6/prompt.txt")
        with open("/search/ai/kaitongyang/ppo_glm_debug/data/bad_case_prompt/fu_1_zheng_2.6/dataset_tmp.id", 'rb') as fp:
...
for cur_big_epoch in range(10):
    for epoch, batch in tqdm(enumerate(ppo_trainer.dataloader)):
        ...
        if epoch % 20 == 0 and str(ppo_trainer.accelerator.device) == "cuda:0":
            reward_path = "/search/ai/jamsluo/GLM_RLHF/ppo_glm/fu_1_zheng_2.5"
