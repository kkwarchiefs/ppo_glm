...
class PPOIdxDataset(Dataset):
    def __init__(self, tokenizer):
        ...
        self.f = open("/search/ai/kaitongyang/ppo_glm_debug/data/same_long_prompt_di_logits/prompt.txt")
        with open("/search/ai/kaitongyang/ppo_glm_debug/data/same_long_prompt_di_logits/dataset_tmp.id", 'rb') as fp:
